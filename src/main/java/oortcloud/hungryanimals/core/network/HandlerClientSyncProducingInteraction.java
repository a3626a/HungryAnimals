...
public class HandlerClientSyncProducingInteraction implements IMessageHandler<PacketClientSyncProducingInteraction, IMessage> {

	@Override
	public IMessage onMessage(PacketClientSyncProducingInteraction message, MessageContext ctx) {
