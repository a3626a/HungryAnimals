...
public class ModKeyBindings {
	...
	public static KeyBinding keyUp = new KeyBinding("change selection UP", 200, "Hungry Animals Debug");
	public static KeyBinding keyDown = new KeyBinding("change selection DOWN", 208, "Hungry Animals Debug");
