...
public class ModItems {
	...
	public static void init() {
		...
		manure = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemManureName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(manure);
		woodash = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemWoodashName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(woodash);
		saltpeter = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemSaltpeterName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(saltpeter);
		tendon = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemTendonName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(tendon);
		wheel = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemWheelName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(wheel);
		straw = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemStrawName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(straw);
		poppycrop = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemPoppyCropName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(poppycrop);
		mixedFeed = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemMixedFeedName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(mixedFeed);
		animalGlue = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemAnimalGlueName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(animalGlue);
		compositeWood = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemCompositeWoodName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(compositeWood);
		compositeWoodCasing = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemCompositeWoodCasingName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
		ModItems.register(compositeWoodCasing);
		blade = new Item().setUnlocalizedName(
				References.RESOURCESPREFIX + Strings.itemBladeName)
				.setCreativeTab(HungryAnimals.tabHungryAnimals);
