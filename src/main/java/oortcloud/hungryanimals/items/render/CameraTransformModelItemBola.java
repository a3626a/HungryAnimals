...
public class CameraTransformModelItemBola implements ISmartItemModel {
	...
	public void setRotation(float angle) {
		ItemTransformVec3f transThird = new ItemTransformVec3f(new Vector3f(0, 90, angle), new Vector3f(-1.25F / 16.0F, (float) ((1.25 + radiusThird * Math.cos(Math.toRadians(angle + 45))) / 16.0F), (float) ((-0.5 + radiusThird
				* Math.sin(Math.toRadians(angle + 45))) / 16.0F)), new Vector3f(0.55F, 0.55F, 0.55F));
		ItemTransformVec3f transFirst = new ItemTransformVec3f(new Vector3f(0, -135, angle), new Vector3f(0, (float) ((2.5 + radiusFirst * Math.cos(Math.toRadians(angle + 45))) / 16.0F), (float) ((4.5 - radiusFirst
