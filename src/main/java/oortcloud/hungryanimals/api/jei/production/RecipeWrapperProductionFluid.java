...
public class RecipeWrapperProductionFluid implements IRecipeWrapper {

	private IProductionJEI recipe;
	private Class<? extends EntityLiving> entityClass;
	private IJeiHelpers jeiHelpers;

	public RecipeWrapperProductionFluid(IJeiHelpers jeiHelpers, Class<? extends EntityLiving> entityClass,
