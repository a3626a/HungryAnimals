...
public class RecipeWrapperProductionMilk implements IRecipeWrapper {

	private IProductionJEI recipe;
	private Class<? extends EntityLiving> entityClass;
	private IJeiHelpers jeiHelpers;

	public RecipeWrapperProductionMilk(IJeiHelpers jeiHelpers, Class<? extends EntityLiving> entityClass,
