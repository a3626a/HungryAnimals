 ...
 * 5. Furthermore, it is essential for the user to modify and to add json files for the configuration purpose. I removed old(-1.8.9) configurations system for mob-drop. The user also have to make json files for each user registered animals from other mods.
 * 
