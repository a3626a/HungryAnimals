...
public class HashDropMeat {
	private HashItemType hashItem;
	private int min_amount;
	private int max_amount;
	
	public HashDropMeat(HashItemType hashItem, int min_amount, int max_amount) {
		this.hashItem = hashItem;
		this.min_amount = min_amount;
		this.max_amount = max_amount;
	}
	
	public HashDropMeat(Item item,int min_amount, int max_amount) {
