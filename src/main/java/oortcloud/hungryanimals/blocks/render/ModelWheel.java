...
public class ModelWheel extends ModelBase {
    ...
    public ModelWheel() {
        ...
        this.shahpe2.addBox(-3.0F, 0.0F, 1.0F, 6, 2, 1, 0.0F);
        this.shahpe5 = new ModelRenderer(this, 0, 19);
        this.shahpe5.setRotationPoint(0.0F, 15.0F, -1.0F);
        this.shahpe5.addBox(-4.0F, 0.0F, -2.0F, 8, 2, 1, 0.0F);
        this.shahpe1 = new ModelRenderer(this, 0, 0);
        this.shahpe1.setRotationPoint(0.0F, 15.0F, 3.0F);
        this.shahpe1.addBox(-2.0F, 0.0F, 1.0F, 4, 2, 1, 0.0F);
        ...
        this.shahpe7.setRotationPoint(0.0F, 15.0F, -3.0F);
        this.shahpe7.addBox(-2.0F, 0.0F, -2.0F, 4, 2, 1, 0.0F);
        this.shahpe6 = new ModelRenderer(this, 0, 23);
        this.shahpe6.setRotationPoint(0.0F, 15.0F, -2.0F);
        this.shahpe6.addBox(-3.0F, 0.0F, -2.0F, 6, 2, 1, 0.0F);
        this.shahpe4 = new ModelRenderer(this, 0, 12);
        this.shahpe4.setRotationPoint(0.0F, 15.0F, 0.0F);
        this.shahpe4.addBox(-5.0F, 0.0F, -2.0F, 10, 2, 4, 0.0F);
        this.shahpe3 = new ModelRenderer(this, 0, 8);
        this.shahpe3.setRotationPoint(0.0F, 15.0F, 1.0F);
        this.shahpe3.addBox(-4.0F, 0.0F, 1.0F, 8, 2, 1, 0.0F);
        this.Wheel.addChild(this.shahpe2);
        this.Wheel.addChild(this.shahpe5);
        this.Wheel.addChild(this.shahpe1);
        this.Wheel.addChild(this.shahpe7);
        this.Wheel.addChild(this.shahpe6);
