...
public class RecipeFactoryShapedDistinctOreRecipe implements IRecipeFactory {
	...
	public IRecipe parse(JsonContext context, JsonObject json) {
		...
		ItemStack output = new ItemStack(ModItems.compositeWood);
		
		IRecipe recipe = new ShapedDistinctOreRecipe(name, output, "abc", "abc", "abc", 'a', "logWood", 'b', new ItemStack(ModItems.animalGlue), 'c', "logWood");
	}
